...
const recoveryZoneConfig = {
  ...
  clientEmail: "firebase-adminsdk-fbsvc@recoveryzonebyzm-admin.iam.gserviceaccount.com",
...
async function exportRecoveryZone() {
  ...
  const collectionsToExport = ["members", "sales", "reservations", "tournaments", "SiteConfig", "services", "settings"];
