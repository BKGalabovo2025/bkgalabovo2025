...
const MORE_CAMP_EXERCISES = [
  // --- BEACH BLOCKS ---
  {
    ...
    category: "physical",
    description:
      "Спринт 10м в пясъка, 1 лицева опора, 1 клек. Връщане назад. Спринт 10м, 2 лицеви, 2 клека. Продължава до 5 и обратно до 1.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Имитация на защитно придвижване на корта (сплит степ и странични крачки), но изпълнявано в дълбок пясък.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Игра на плажен волейбол, но с фокус върху движението и предвиждането на топката. Отличен крос-тренинг за бадминтон.",
    coachingPoints: [
  ...
  // --- CIRCUIT (СТАНЦИОННИ РОТАЦИИ) ---
  {
    ...
    category: "physical",
    description:
      "Хвърляне на медицинска топка в стена с усукване на торса (Russian Twists). Симулира ротацията при смач и клиър.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Бързо докосване на ръба на плиометрична кутия или стъпало с пръстите на краката, редувайки ляв-десен крак.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Упражнения с тренировъчни ластици за вътрешна и външна ротация на рамото. Превенция на контузии.",
    coachingPoints: [
  ...
  // --- TACTICAL / MULTI-SHUTTLE ---
  {
    ...
    category: "tactics",
    description:
      "Треньорът подава 30 пера бързо надолу към играча. Играчът трябва да ги върне с блокращ или драйв удар от защита.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "tactics",
    description:
      "Двама състезатели атакуват постоянно един състезател, който трябва да се защитава и да търси пролуки за контра-атака.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "technique",
    description:
      "Треньорът подава пера произволно в 4-те ъгъла на корта. Играчът трябва да се придвижи, удари и бързо да се върне в центъра.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "tactics",
    description:
      "Подаване на високо перо за смач, веднага последвано от късо подаване на мрежата за убиване/завършване.",
    coachingPoints: [
