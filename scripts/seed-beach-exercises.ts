...
const BEACH_EXERCISES = [
  {
    ...
    category: "physical",
    description:
      "Нареждат се конуси зиг-заг в пясъка. Спринт до първия, докосване, спринт до втория. На връщане - бягане назад.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Дълбоки жабешки подскоци от клек до клек. 10 подскока напред, кратка почивка, 10 назад.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Класическо дърпане на въже, но в дълбок пясък. Разделяте отбора на две равни групи. Чудесно за сила на ядрото и екипен дух.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Изпълнява се 1 бърпи (burpee), след което експлозивен спринт 5 метра по посока водата, спиране и връщане със заден ход.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Партньор те държи с тренировъчен ластик през кръста, докато правиш придвижване напред и назад в пясъка, симулирайки удари (Shadow).",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "physical",
    description:
      "Ходене на 4 крака (Меча походка напред, Рачешко ходене назад) за 10-15 метра в пясъка. Укрепва цялото тяло - рамене, ядро, крака.",
    coachingPoints: [
