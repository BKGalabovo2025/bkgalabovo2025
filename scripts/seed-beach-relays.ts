...
const BEACH_RELAYS = [
  {
    ...
    category: "games",
    description:
      "Децата се разделят на 2 отбора. Всяко дете държи ракета като тиган (хват за форхенд на мрежата) с едно перо върху кордажа. Трябва да пробягат през дълбокия пясък до конуса и обратно, без да изпуснат перото. Ако падне, спират, слагат го и продължават.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Разделяте ги на отбори. Всеки отбор има празна кофа на сухия пясък и една малка пластмасова чашка. Първият спринтира до морето, пълни чашката, спринтира обратно и я излива в кофата. Предава чашката на следващия. Печели първият отбор, прелял кофата.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Отборите се строяват на брега, където водата е до глезените (плитчина). При сигнал, първият става на 'рак' (на четири крака, с корем към небето) и върви в плитката вода до конуса и обратно. Предава щафетата с 'дай пет'.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Треньорът хвърля 50 стари пера в морето (в плитката част, където няма вълни). Отборите са строени на 15 метра на пясъка. Всяко дете спринтира във водата, взима САМО ЕДНО перо и се връща. Отборът събрал най-много пера печели.",
    coachingPoints: [
  ...
  },
  {
    ...
    category: "games",
    description:
      "Наредени конуси на всеки 5 метра. От старта до първия конус - спринт. От първия до втория - ниско военно пълзене в пясъка. От втория до третия (до водата) - жабешки подскоци. Докосват водата и спринт обратно до старта.",
    coachingPoints: [
...
async function run() {
  ...
  const genericDoc = exSnap.docs.find(
    (d) => d.data().name === "Плажни отборни и щафетни игри"
  );
  if (genericDoc) {
