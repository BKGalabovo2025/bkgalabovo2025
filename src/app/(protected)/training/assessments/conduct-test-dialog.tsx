...
export default function ConductTestDialog({
  ...
  useEffect(() => {
    if (open) {
      ...
      setParticipants([
        { memberId: "", scoreDisplay: "", scoreNum: 0, notes: "" },
      ]);
    }
  }, [open]);
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 mt-4">
          <div className="bg-zinc-50 p-4 rounded-xl text-sm border border-zinc-100">
            ...
            <p className="mt-2">
              <strong>Оценяване:</strong> {test.scoring}
            </p>
          </div>
                  ...
                  >
                    <div className="flex-1 w-full">
                      <Select
                        value={p.memberId}
                        onValueChange={(val) =>
                          updateParticipant(index, "memberId", val)
                        }
                      >
                        <SelectTrigger>
