    ...
    <SidebarProvider defaultOpen={true}>
      <div className="flex min-h-screen w-full bg-slate-50/50 dark:bg-zinc-950/50 font-sans">
        ...
        <SidebarInset className="flex flex-col flex-1 min-w-0 overflow-hidden border-l border-gray-100 dark:border-zinc-800">
          ...
          <header className="flex h-20 shrink-0 items-center gap-6 border-b border-zinc-100 dark:border-zinc-900 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md px-10 sticky top-0 z-30 shadow-none">
            ...
            <div className="flex-1">
              <h1 className="font-medium text-[11px] uppercase tracking-[0.4em] text-zinc-900 dark:text-white opacity-80">
          ...
          <main className="flex-1 overflow-y-auto">
            <div className="max-w-[1400px] mx-auto p-8 md:p-10 lg:p-12 animate-in fade-in slide-in-from-bottom-2 duration-1000">
              {children}
            </div>
          </main>
        </SidebarInset>
