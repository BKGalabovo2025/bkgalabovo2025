      ...
      <section id="about" className="py-24 px-6 bg-zinc-950 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-6">
            ...
            динамичен спорт. Клубът организира регулярни тренировки за всички
            възрастови групи – деца, юноши, възрастни и ветерани. Гордеем се с
            нашата общност, която не спира да расте и да постига спортни
            върхове.
          </p>

          <h3 className="text-2xl font-light tracking-tight text-white mt-10 mb-4">
            Нашата кауза:
          </h3>
          <p className="text-zinc-300 text-md leading-relaxed">
            ...
            сигурна среда за децата – далеч от застоялия живот пред телефоните,
            затлъстяването и пороците на съвременното общество (като алкохол и
            наркотици). Вярваме, че спортът изгражда физическа дисциплина,
            възпитава характер, борбеност и екипен дух.
          </p>
        </div>
      </section>
