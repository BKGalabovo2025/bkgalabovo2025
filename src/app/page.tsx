...
export default function HomePage() {
  ...
  const [hovered, setHovered] = useState<"bk" | "recovery" | "admin" | null>(null);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-5xl">
          ...
          >
            ...
            <h2 className="text-xl font-medium text-white mb-2">Recovery Zone</h2>
            <p className="text-zinc-500 text-sm leading-relaxed mb-8 flex-1">
          ...
          >
            ...
            <h2 className="text-xl font-medium text-zinc-400 mb-2">Администратор</h2>
            <p className="text-zinc-600 text-sm leading-relaxed mb-8 flex-1">
              Вход за управление на двата проекта — членове, финанси,
              резервации и настройки.
            </p>
            <div className="flex flex-col gap-2">
              <Link
                href="/login"
      ...
      <footer className="relative z-10 px-8 py-6 border-t border-white/5 flex items-center justify-between">
        ...
        <span className="text-[10px] text-zinc-700 uppercase tracking-widest">Sofia & Galabovo</span>
      </footer>
    </div>
  );
}
