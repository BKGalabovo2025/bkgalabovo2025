    ...
    questions: [
      {
        ...
        type: "rating",
        label: "Треньорски подход и внимание към децата",
        description: "Индивидуално отношение, професионализъм и грижа",
        required: true,
        category: "coaching",
      },
      {
        ...
        type: "rating",
        label: "Спортна атмосфера и дисциплина в залата",
        description: "Приятелска среда, екипен дух и мотивация",
        required: true,
        category: "atmosphere",
      },
      {
        ...
        type: "rating",
        label: "Организация и комуникация от екипа",
        description: "Информираност, координация и бърз отговор",
        required: true,
        category: "organization",
      },
      {
        ...
        type: "select",
        label: "Препоръчвате ли Бадминтон клуб Гълъбово на приятели?",
        required: true,
        options: [
