...
>[] = [
  ...
  },
  {
    ...
    description:
      "Цялостна обратна връзка за дейността на клуба, треньорския подход, атмосферата и удовлетвореността.",
    eventType: "general",
    isDefault: true,
    questions: [
      {
        id: "q_coaching_approach",
        type: "rating",
        label: "Треньорски подход, професионализъм и внимание към децата",
        description: "Индивидуално отношение, мотивация и грижа",
        required: true,
        category: "coaching",
      },
      {
        id: "q_environment_discipline",
        type: "rating",
        label: "Спортна атмосфера, екипен дух и дисциплина в залата",
        description: "Приятелска среда, уважение и позитивна енергия",
        required: true,
        category: "atmosphere",
      },
      {
        id: "q_communication_org",
        type: "rating",
        label: "Организация, графици и комуникация с екипа",
        description: "Информираност, бърз отговор и координация",
        required: true,
        category: "organization",
      },
      {
      ...
      },
      {
        ...
        required: true,
        options: [
          "Категорично да! С две ръце!",
          "Да, доволен/на съм",
          "Бих препоръчал(а) при определени условия",
        ],
        category: "general",
      },
      {
        id: "q_club_strengths",
        type: "text",
        label: "Какво най-много цените в работата на клуба?",
        description:
          "Какво според Вас прави клуба специален за Вас или Вашето дете?",
        required: false,
        category: "general",
      },
      {
        id: "q_club_improvements",
        type: "text",
        label: "Какво бихте искали да подобрим или надградим занапред?",
        description:
          "Идеи за нови събития, инициативи, оборудване или тренировки",
        required: false,
        category: "general",
      },
    ],
