      ...
      <div className="p-6 md:p-8 border-b border-zinc-100 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-1 font-light">
            Проследяване на всички движения и промени по услугите.
          </p>
        </div>
      ...
      <div className="flex-1 overflow-auto custom-scrollbar">
        {filteredEvents.length > 0 ? (
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center">
            <History className="h-12 w-12 text-zinc-200 dark:text-zinc-800 mb-4" strokeWidth={1} />
            <p className="text-zinc-500 text-sm font-light">Няма намерени движения.</p>
          </div>
        )}
      </div>
    </div>
