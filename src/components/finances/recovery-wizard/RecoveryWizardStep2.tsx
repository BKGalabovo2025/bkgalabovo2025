...
import { MonthAttendance } from "./RecoveryWizardContext";
...
const RecoveryWizardStep2Subscription = ({
  selectedMember,
  monthlyAttendance,
  unpaidMonths,
  selectedMonthKeys,
...
const RecoveryWizardStep2Individual = ({
  selectedMember,
  unpaidEvents,
  selectedEventIds,
  setSelectedEventIds,
    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        if (paymentMode === "subscription") {
          return (
            <RecoveryWizardStep2Subscription
