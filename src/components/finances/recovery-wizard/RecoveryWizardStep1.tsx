...
const RecoveryWizardStep1NewGuestForm = ({
  newGuestFirstName,
...
const RecoveryWizardStep1MemberList = ({
  filteredMembers,
  selectedMember,
  clientTypeTab,
  setSelectedMember,
...
export const RecoveryWizardStep1 = () => {
  const {
    showNewGuestForm,
    setShowNewGuestForm,
    clientTypeTab,
  ...
  return (
    <div className="space-y-5">
      ...
      {showNewGuestForm ? (
        <RecoveryWizardStep1NewGuestForm
