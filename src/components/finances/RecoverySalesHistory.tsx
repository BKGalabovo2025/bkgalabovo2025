    ...
    <div className="flex flex-col h-full bg-white dark:bg-zinc-950">
      <div className="p-6 md:p-8 border-b border-zinc-100 dark:border-zinc-900">
        ...
        <p className="text-xs text-zinc-500 mt-1 font-light">
          Проследяване на всички направени продажби на възстановяване.
        </p>
      </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mt-2 pt-3 border-t border-zinc-100 dark:border-zinc-800">
                {sale.isPaid ? (
                  <Badge
                    variant="outline"
                    className="bg-emerald-50 text-emerald-600 border-emerald-100 dark:bg-emerald-500/10 dark:text-emerald-500 dark:border-emerald-500/20 px-2 py-0.5"
                  >
                    <CheckCircle2 className="w-3 h-3 mr-1" /> Платено
                  </Badge>
                ) : (
                  <Badge
                    variant="outline"
                    className="bg-rose-50 text-rose-600 border-rose-100 dark:bg-rose-500/10 dark:text-rose-500 dark:border-rose-500/20 px-2 py-0.5"
                  >
                    <XCircle className="w-3 h-3 mr-1" /> Неплатено
                  </Badge>
                )}
