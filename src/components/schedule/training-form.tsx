...
const trainingSchema = z.object({
  title: z.string().default('Тренировка'),
...
export default function TrainingForm({ event, onSave, onDelete, onClose, isSaving }: TrainingFormProps) {
