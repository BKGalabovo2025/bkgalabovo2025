      ...
      <div className="overflow-x-auto pb-4">
        <div className="flex min-w-max items-start gap-6">
          {rounds.map(({ round, matches: roundMatches }, colIdx) => (
            <div key={round} className="flex w-72 flex-col gap-4">
              {/* Round header */}
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      isCompleted
                        ...
                        : "border-zinc-100 bg-white hover:border-primary/30 dark:border-zinc-800 dark:bg-zinc-950"
                    )}
                  >
                    {/* Completed badge */}
                    {isCompleted && (
                      <div className="px-4 pt-3 pb-1">
                        <span className="text-[8px] font-black tracking-[0.3em] text-emerald-500 uppercase">
                          Завършен
                        </span>
                      </div>
                    )}
                    ...
                    <div className="space-y-2 px-4 pt-2 pb-3">
                      {isBye ? (
                        <div className="flex items-center gap-2 py-2 text-zinc-300 dark:text-zinc-600">
                        ...
                        <>
                          ...
                          <div
                            className={cn(
                              ...
                              isCompleted &&
                                ...
                                : isCompleted
                                  ? "bg-zinc-100/50 text-zinc-400 dark:bg-zinc-800/50"
                            ...
                            <div className="flex min-w-0 items-center gap-2">
                              {isCompleted &&
                                match.winnerEntryId ===
                                  ...
                                  <Trophy className="size-3 shrink-0 text-yellow-300" />
                                )}
                          ...
                          <div className="flex items-center justify-between px-1">
                            <span className="text-[9px] font-medium tracking-widest text-zinc-300 uppercase dark:text-zinc-600">
                              срещу
                            </span>
                            {isCompleted && match.score && (
                              <span className="font-mono text-[11px] font-bold tracking-wider text-zinc-600 dark:text-zinc-400">
                                {match.score}
                              </span>
                            )}
                          </div>
