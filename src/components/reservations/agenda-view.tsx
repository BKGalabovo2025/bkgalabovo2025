...
const ReservationCard: React.FC<CardProps<Reservation>> = ({
  ...
  return (
    <div
      className={cn(
        "absolute w-[95%] left-1/2 -translate-x-1/2 p-2 rounded-lg border text-xs leading-tight shadow-md transition-all duration-300 group",
      ...
      >
        {Object.keys(eventsByCourt).map((courtIdStr) => {
          ...
          return (
            ...
            >
              <div className="text-center font-semibold py-2 border-b border-border sticky top-0 bg-background/95 z-10">
                Корт {courtId}
              </div>
