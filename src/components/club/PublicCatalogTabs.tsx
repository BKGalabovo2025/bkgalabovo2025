                  ...
                  {(() => {
                    ...
                    return (
                      <a
                        ...
                        className={`inline-flex items-center justify-center gap-2 rounded-xl bg-green-600 px-6 py-2 text-sm font-bold tracking-widest text-white uppercase shadow-lg shadow-green-600/20 transition-colors hover:bg-green-700 ${!showPrice ? "w-full sm:w-auto" : ""}`}
                      >
                        <svg
