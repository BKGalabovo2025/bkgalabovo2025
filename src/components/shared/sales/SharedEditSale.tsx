                  ...
                  {availableProducts.map((product) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right">
                        <span className="rounded-full border border-transparent bg-zinc-100 px-2.5 py-1 text-[11px] font-medium tracking-wide text-zinc-600 dark:bg-zinc-900 dark:text-zinc-400">
                          {product.stock} бр.
                        </span>
                      </TableCell>
                      <TableCell className="text-right">
                ...
                >
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="rounded-md bg-zinc-50 px-2 py-0.5 text-[10px] font-medium tracking-wide text-zinc-500 dark:bg-zinc-900 dark:text-zinc-400">
