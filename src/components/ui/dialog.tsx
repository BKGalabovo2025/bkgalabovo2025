...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed top-[50%] left-[50%] z-50 grid max-h-[90vh] w-full max-w-lg -translate-1/2 gap-6 overflow-y-auto border border-zinc-100 bg-white p-8 shadow-2xl shadow-zinc-200/20 duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] data-[state=open]:zoom-in-95 sm:rounded-4xl dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-none",
        className
      )}
      {...props}
    >
